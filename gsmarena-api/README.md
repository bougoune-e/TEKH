...
This utility transforms GSMArena memory strings into structured JSON objects.

```js
const memory = gsmarena.memoryParser.parseMemorySpec("128GB 8GB RAM, 256GB 12GB RAM");
console.log(memory);
```
