          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-border bg-card p-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={buildWhatsAppUrl("Bonjour TEKH+, je vous contacte depuis la page Contact du site.") || "https://wa.me/22897628117"} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="h-9 w-9 inline-flex items-center justify-center rounded-lg border border-border hover:bg-accent transition-smooth">
